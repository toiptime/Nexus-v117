    ...
    private void handlePassiveSkills(MapleCharacter chra) {
        ...
        switch (chra.getJob()) {
            ...
            case 2412: { // Phantom
                ...
                bx = SkillFactory.getSkill(24100006); // Devils Luck,Physical training for phantoms
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
            ...
            case 3112://Demon slayer
                ...
                bx = SkillFactory.getSkill(31100005);// Physical training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
            ...
            case 1511:
            case 1512: {
                bx = SkillFactory.getSkill(15100009);// Physical Training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
            ...
            case 3312: {// Wild hunter
                bx = SkillFactory.getSkill(33100010);// Physical Training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
        ...
        switch (chra.getJob()) {
            ...
            case 312: {
                ...
                bx = SkillFactory.getSkill(3100006);// Physical Training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
            ...
            case 322: {
                ...
                bx = SkillFactory.getSkill(3200006);// Physical Training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
            ...
            case 2111:
            case 2112: { // Aran
                bx = SkillFactory.getSkill(21100008);// Physical Training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
            ...
            case 111:
            case 112: {
                bx = SkillFactory.getSkill(1100009);// Physical training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
            ...
            case 132: {
                ...
                bx = SkillFactory.getSkill(1300009);// Physical Training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    damageIncrease.put(1001004, eff.getX());
            ...
            case 1411:
            case 1412: {
                bx = SkillFactory.getSkill(14100010);// Physical Training
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localluk += eff.getLukX();
    ...
    public boolean checkEquipDurabilitys(final MapleCharacter chr, int gain, boolean aboveZero) {
        ...
        for (Equip item : all) {
            if (item != null && ((item.getPosition() >= 0) == aboveZero)) {
                ...
                if (item.getDurability() < 0) { // Shouldn't be less than 0.
