...
function start() {                    
        ...
        cm.sendOk("Please come back to me when you have an Android.");
        cm.dispose();
        } else {
    status = -1;
    action(1, 0, 0);
...
function action(mode, type, selection) {
    ...
    status--;
    if (status == 0) {    
        cm.sendSimple("Hello #b#h ##k,\r\n\r\nI am the Android Styler. I can change your Android looks, what do you want to change?\r\n#L0##bHair#l\r\n#L1#Hair Color#l\r\n#L2#Face#l\r\n#L3#Eye Color#l");
    } else if (status == 1) {
