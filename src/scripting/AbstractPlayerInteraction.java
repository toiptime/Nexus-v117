...
import constants.DefaultSettings;
...
public abstract class AbstractPlayerInteraction {
    ...
    public final void gainNXCredit(final int amount) {
    ...
    public final void evanTutorial(final String data, final int v1) {
        c.getSession().write(NPCPacket.getTutorialUI(data));
    }

    public final void tutorialUI(final String data) {
        c.getSession().write(NPCPacket.getTutorialUI(data));
    }
...
//        map.setChangeableMobUsing(true);
    ...
    public void getDirectionInfo(String data, int value, int x, int y, int pro) {
        c.getSession().write(CField.UIPacket.getDirectionInfo(data, value, x, y, pro));
    }

    public void getDirectionInfoTest(byte type, int value) {
        c.getSession().write(CField.UIPacket.getDirectionInfoTest(type, value));
    }
