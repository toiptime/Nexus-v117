...
function monsterSpawn(eim) { // Custom function
    ...
    switch (monsterid) {
        ...
        case 4130103: // Rombot
            ...
            modified.setOMp(mob.getMobMaxMp() * 4);
...
function allMonstersDead(eim) {
    ...
    if (mobnum < monster.length) {
        ...
        eim.saveBossQuest(5);
        eim.broadcastPlayerMsg(5, "Your party has beaten the NORMAL mode and have gained 5 extra points!");
		eim.giveAchievement(150);
    }
