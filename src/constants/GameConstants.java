...
public class GameConstants {
    ...
    public static boolean isAswanMap(int mapId) {
        return mapId >= 262021020 && mapId <= 262023130;
    }
    ...
    public enum QuickMove {
        ...
        A(9070004, 0, 30, "Move to the Battle Mode zone #cBattle Square#, where you can fight against other users.\n#cLv. 30 or above can participate in Battle Square."),
        B(9010022, 2, 10, "Use the #cDimensional Mirror# to move to a variety of party quests."),
        C(9071003, 1, 20, "Move to the party zone \n#cMonster Park#, where you can fight against strong monsters with your party members.\n#cOnly Lv. 20 or above can participate in the Monster Park."),
        D(9000086, 5, 0, "Move to the closest #cIntercontinental Station# to your current location."),
        E(9000087, 3, 0, "Move to the #cFree Market#, where you can trade items with other users."),
        F(9000088, 4, 30, "Move to #cArdentmill#, the town of Professions.\n#cOnly Lv. 30 or above can move to Ardentmill"),
        G(9000089, 6, 0, "Take the #cTaxi# to move to major areas quickly."),
        H(9010041, 10, 30, "Receive Part-Time Job reward.");
        //tempest:
