...
function action(mode, type, selection) {
    ...
    cm.sendSimple ("Hello #r#h ##k, Welcome to the #rVotepoint Exchanger Npc.#k\r\nYou have #r[" + cm.getVPoints() +"]#k Votepoints#k." +
         ...
         "#k\r\nWhat would you like?" +
				...
				"#k\r\n#L506##b#i1112586# Lightning God Ring [ULTRA RARE!] - 15 VP Each");//1112586
                ...
                if (cm.getVPoints() > 0) {      
                    cm.setVPoints(-1);                   
                    cm.gainItem(5211046, 2);// 2x Coupon
                    cm.dispose();
                    } else {
                    cm.sendOk(Error);
                    cm.dispose();
                ...
                if (cm.getVPoints() > 0) {      
                    cm.setVPoints(-1);                   
                    cm.gainItem(5211048, 3);// 1.3 Coupon
                    cm.dispose();
                    } else {
                    cm.sendOk(Error);
                    cm.dispose();
                ...
                if (cm.getVPoints() > 0) {      
                    cm.setVPoints(-1);                    
                    cm.gainItem(5360042, 2);// 2x Drop Coupon
                    cm.dispose();
                    } else {
                    cm.sendOk(Error);
                    cm.dispose();
                ...
                if (cm.getVPoints() > 0) {      
                    cm.setVPoints(-1);                    
                    cm.gainItem(5360000, 2);// 2x Meso Coupon
                    cm.dispose();
                    } else {
                    cm.sendOk(Error);
                    cm.dispose();
                ...
                if (cm.getVPoints() > 14) {      
                    cm.setVPoints(-15);                    
                    cm.gainItem(1112586, 1);//Lightning God Ring
                    cm.dispose();
                    } else {
                    cm.sendOk(Error);
                    cm.dispose();
