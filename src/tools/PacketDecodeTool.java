...
public class PacketDecodeTool {
    ...
    public static final String[] hex = {"0", "|", "1", "}", "2", "~", "3", "€", "4", "‚", "5", "ƒ", "6", "„", "7", "…", "8", "†", "9", "‡", "@", "ˆ", "A", "‰", "B", "Š", "C", "‹", "D", "Œ", "E", "Ž", "F", "‘", "G", "’", "H", "“", "I", "”", "J", "•", "K", "–", "L", "—", "M", "˜", "N", "™", "O", "š", "P", "›", "Q", "œ", "R", "ž", "S", "Ÿ", "T", "�", "U", " ", "V", "!", "W", "#", "X", "$", "Y", "%", "Z", "^", "[", "&", "'\'", "'", "]", "(", "^", ")", "_", "*", "`", "+", "a", ",", "b", "-", "c", ".", "d", "/", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z", "{"};
