...
public class MapleSquad {
    ...
    public String getNextPlayer() {
        ...
        sb.append("#b").append(type.queue.get(ch).size()).append(" #k ").append("\r\n\r\nList Of Participants : \n\r ");
        int i = 0;
    ...
    public String getSquadMemberString(byte type) {
        switch (type) {
            ...
            case 1: {
                StringBuilder sb = new StringBuilder("Squad Members: ");
                sb.append("#b").append(members.size()).append(" #n ").append("\r\n\r\nList Of Participants : \n\r ");
                int i = 0, selection = 0;
                for (Entry<String, String> chr : members.entrySet()) {
                    i++;
    ...
    public enum MapleSquadType {
        bossbalrog(2), zak(2), chaoszak(3), horntail(2), chaosht(3), pinkbean(2), nmm_squad(2), vergamot(2), dunas(2), nibergen_squad(2), dunas2(2), core_blaze(2), aufheben(2), cwkpq(3), tokyo_2095(2), vonleon(3), scartar(2), cygnus(3), hilla(2), darkhilla(3), arkarium(3);
