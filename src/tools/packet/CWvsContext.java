...
public class CWvsContext {
    ...
    public static byte[] Mulung_Pts(int recv, int total) {
        return showQuestMsg(new StringBuilder().append("You have received ").append(recv).append(" training points and accumulated a total of ").append(total).append(" training points.").toString());
    }
    ...
    public static byte[] getGiftWindow() { //Not Completed
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

        //For now:
        HexTool.getByteArrayFromHexString("09 04 00 00 00 8C 0C 00 00 00 00 58 FD FA C1 CD 01 80 A9 A3 25 7B C7 CD 01 03 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 80 05 BB 46 E6 17 02 00 00 00 00 63 00 00 00 00 00 00 00 00 00 00 00 9D FF FF FF 9D FF FF FF 00 00 00 00 00 00 9E 00 4D 50 20 66 6F 72 20 43 61 73 68 20 53 68 6F 70 20 53 75 70 72 69 73 65 20 42 6F 78 2F 47 65 74 20 39 39 20 4D 61 70 6C 65 20 50 6F 69 6E 74 73 20 66 6F 72 20 66 72 65 65 20 61 73 20 70 61 72 74 20 6F 66 20 74 68 65 20 43 61 73 68 20 53 68 6F 70 20 72 65 76 61 6D 70 20 63 65 6C 65 62 72 61 74 69 6F 6E 21 20 20 43 6F 6C 6C 65 63 74 20 74 68 65 6D 20 62 65 66 6F 72 65 20 4E 6F 76 65 6D 62 65 72 20 32 31 2C 20 6F 72 20 74 68 65 79 27 6C 6C 20 64 69 73 61 70 70 65 61 72 2E");
        //mplew.write(9);
        //mplew.writeInt(1); //number of gifts
        //continue here
        //mplew.writeMapleAsciiString("Test Gift"); //gift description
    ...
    public static class ExpeditionPacket {
        ...
        public static byte[] expeditionStatus(MapleExpedition me, boolean created, boolean silent) {
            ...
            mplew.write(created ? 74 : silent ? 72 : 76);
