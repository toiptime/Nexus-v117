...
function allMonstersDead(eim) {
	...
	eim.saveBossQuest(11);;
	eim.broadcastPlayerMsg(5, "Your party has beaten the HARD mode and have gained 11 extra points!");
	eim.giveAchievement(151);
    }
