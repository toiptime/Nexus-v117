...
function allMonstersDead(eim) {
    ...
    if (monster_number > 19) {
        map.broadcastMessage(tools.MaplePacketCreator.serverNotice(6, "[The Boss Quest] Congratulations! Your party has defeated all the bosses with " + points + " points!"));
        ...
        map.broadcastMessage(tools.MaplePacketCreator.serverNotice(6, "[The Boss Quest] Your party now has " + points + " points! The next boss will spawn in 10 seconds."));
