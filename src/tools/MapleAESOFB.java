...
public class MapleAESOFB {
    ...
    // V118 - V119:
    //private final static SecretKeySpec skey118 = new SecretKeySpec(new byte[]{0x5A, 0x00, 0x00, 0x00, 0x22, 0x00, 0x00, 0x00, (byte)0xFB, 0x00, 0x00, 0x00, (byte)0xD1, 0x00, 0x00, 0x00, (byte)0x8F, 0x00, 0x00, 0x00, (byte)0x93, 0x00, 0x00, 0x00, (byte)0xCD, 0x00, 0x00, 0x00, (byte)0xE6, 0x00, 0x00, 0x00}, "AES");
    // V120:
    //private final static SecretKeySpec skey120 = new SecretKeySpec(new byte[]{(byte) 0x8D, 0x00, 0x00, 0x00, (byte) 0xD5, 0x00, 0x00, 0x00, (byte) 0xD0, 0x00, 0x00, 0x00, 0x2B, 0x00, 0x00, 0x00, (byte) 0xA8, 0x00, 0x00, 0x00, (byte) 0xFF, 0x00, 0x00, 0x00, 0x74, 0x00, 0x00, 0x00, (byte) 0xFE, 0x00, 0x00, 0x00}, "AES");
    //V121:
    //private final static SecretKeySpec skey121 = new SecretKeySpec(new byte[] {(byte) 0xC0, 0x00, 0x00, 0x00, 0x37, 0x00, 0x00, 0x00, (byte) 0xFF, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, (byte) 0xDD, 0x00, 0x00, 0x00, 0x73, 0x00, 0x00, 0x00, 0x57, 0x00, 0x00, 0x00, (byte) 0xC4, 0x00, 0x00, 0x00, 0x03}, "AES");
    //V122:
    //private final static SecretKeySpec skey122 = new SecretKeySpec(new byte[] {0x6D, 0x00, 0x00, 0x00, (byte) 0xCC, 0x00, 0x00, 0x00, (byte) 0xFD, 0x00, 0x00, 0x00, (byte) 0x99, 0x00, 0x00, 0x00, 0x23, 0x00, 0x00, 0x00, 0x3E, 0x00, 0x00, 0x00, 0x30, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00, 0x00}, "AES");
    // KMS
    ...
    //private final static SecretKeySpec skey = ServerConstants.MAPLE_VERSION <= 117 ? skey117 : ServerConstants.MAPLE_VERSION <= 119 ? skey118 : ServerConstants.MAPLE_VERSION <= 120 ? skey120 : ServerConstants.MAPLE_VERSION <= 121 ? skey121 : ServerConstants.MAPLE_VERSION <= 122 ? skey122 : skey122;
    /* VANA */
    ...
    public enum EncryptionKey {
        ...
        V117(new SecretKeySpec(new byte[]{0x13, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, (byte) 0xB4, 0x00, 0x00, 0x00, 0x1B, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x33, 0x00, 0x00, 0x00, 0x52, 0x00, 0x00, 0x00}, "AES")),
        V118(new SecretKeySpec(new byte[]{0x5A, 0x00, 0x00, 0x00, 0x22, 0x00, 0x00, 0x00, (byte) 0xFB, 0x00, 0x00, 0x00, (byte) 0xD1, 0x00, 0x00, 0x00, (byte) 0x8F, 0x00, 0x00, 0x00, (byte) 0x93, 0x00, 0x00, 0x00, (byte) 0xCD, 0x00, 0x00, 0x00, (byte) 0xE6, 0x00, 0x00, 0x00}, "AES")),
        V120(new SecretKeySpec(new byte[]{(byte) 0x8D, 0x00, 0x00, 0x00, (byte) 0xD5, 0x00, 0x00, 0x00, (byte) 0xD0, 0x00, 0x00, 0x00, 0x2B, 0x00, 0x00, 0x00, (byte) 0xA8, 0x00, 0x00, 0x00, (byte) 0xFF, 0x00, 0x00, 0x00, 0x74, 0x00, 0x00, 0x00, (byte) 0xFE, 0x00, 0x00, 0x00}, "AES")),
        V121(new SecretKeySpec(new byte[]{(byte) 0xC0, 0x00, 0x00, 0x00, 0x37, 0x00, 0x00, 0x00, (byte) 0xFF, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, (byte) 0xDD, 0x00, 0x00, 0x00, 0x73, 0x00, 0x00, 0x00, 0x57, 0x00, 0x00, 0x00, (byte) 0xC4, 0x00, 0x00, 0x00, 0x03}, "AES")),
        V122(new SecretKeySpec(new byte[]{0x6D, 0x00, 0x00, 0x00, (byte) 0xCC, 0x00, 0x00, 0x00, (byte) 0xFD, 0x00, 0x00, 0x00, (byte) 0x99, 0x00, 0x00, 0x00, 0x23, 0x00, 0x00, 0x00, 0x3E, 0x00, 0x00, 0x00, 0x30, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00, 0x00}, "AES")),
        V123(new SecretKeySpec(new byte[]{(byte) 0xFA, 0x00, 0x00, 0x00, (byte) 0xE0, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00, 0x00, (byte) 0xE8, 0x00, 0x00, 0x00, (byte) 0xC9, 0x00, 0x00, 0x00, 0x3F, 0x00, 0x00, 0x00, 0x72, 0x00, 0x00, 0x00, (byte) 0x92, 0x00, 0x00, 0x00}, "AES"));
        private SecretKeySpec skey;

        EncryptionKey(SecretKeySpec skey) {
            this.skey = skey;
        }
