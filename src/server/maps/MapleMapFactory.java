...
public class MapleMapFactory {
    ...
    private final MapleDataProvider source = MapleDataProviderFactory.getDataProvider(new File("wz/Map.wz"));
    private final MapleData nameData = MapleDataProviderFactory.getDataProvider(new File("wz/String.wz")).getData("Map.img");
