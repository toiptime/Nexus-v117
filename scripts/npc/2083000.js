...
function start() {
		if (cm.getPlayer().getLevel() < 140) {
			cm.sendOk("There is a level requirement of 140 to attempt Chaos Horntail.");
			cm.dispose();
			return;
		}
...
function action(mode, type, selection) {
	...
	case 0:
	    	if (mode == 1) {
			if (cm.registerSquad("Chaosht", 5, " has been named the Leader of the squad (Regular). If you would you like to join please register for the Expedition Squad within the time period.")) {
