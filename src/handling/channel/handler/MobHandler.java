    ...
    public static final void MoveMonster(LittleEndianAccessor slea, MapleClient c, MapleCharacter chr) {
        ...
        if (useSkill) {
            ...
            if (size > 0) {
                ...
                realskill = skillToUse.getLeft().intValue();
                level = skillToUse.getRight().intValue();
        ...
        try {
            ...
            FileoutputUtil.log("Log_Movement.rtf", "MOBID " + monster.getId() + ", AIOBE Type2:\n" + slea.toString(true));
            return;
        }
