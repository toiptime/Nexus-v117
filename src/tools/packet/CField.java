...
import constants.GameConstants.QuickMove;
...
public class CField {
    ...
    public static byte[] updateInnerPotential(byte ability, int skill, int level, int rank) {
        ...
        mplew.write(ability); //1-3
        mplew.write(0); //we can always turn ability to short, because it does nothing
        mplew.writeInt(skill); //skill id (7000000+)
        mplew.write(level); //level, 0 = blank inner ability
        mplew.write(0);
        mplew.write(rank); //rank
        mplew.write(0);
        mplew.write(1); //0 = no update
    ...
    public static byte[] getQuickMoveInfo() {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        /* V122:
         * [6/1/2012 9:04:20 AM] (55) <Inbound> ==
         * E5 00
         * 07
         *
         * 00 00
         ...
         * 00 00 00 00 //0
         * 1E 00 00 00 //30
         * 8B 00 4D 6F 76 65 20 74 6F 20 74 68 65 20 42 61 74 74 6C 65 20 4D 6F 64 65 20 7A 6F 6E 65 20 23 63 42 61 74 74 6C 65 20 53 71 75 61 72 65 23 2C 20 77 68 65 72 65 20 79 6F 75 20 63 61 6E 20 66 69 67 68 74 20 61 67 61 69 6E 73 74 20 6F 74 68 65 72 20 75 73 65 72 73 2E 0A 23 63 4C 76 2E 20 33 30 20 6F 72 20 61 62 6F 76 65 20 63 61 6E 20 70 61 72 74 69 63 69 70 61 74 65 20 69 6E 20 42 61 74 74 6C 65 20 53 71 75 61 72 65 2E
         * Move to the Battle Mode zone #cBattle Square#, where you can fight against other users.\n#cLv. 30 or above can participate in Battle Square.
         * 00 00
         * 66 7B 89 00 //9010022
         * 02 00 00 00 //2
         * 0A 00 00 00 //10
         * 43 00 55 73 65 20 74 68 65 20 23 63 44 69 6D 65 6E 73 69 6F 6E 61 6C 20 4D 69 72 72 6F 72 23 20 74 6F 20 6D 6F 76 65 20 74 6F 20 61 20 76 61 72 69 65 74 79 20 6F 66 20 70 61 72 74 79 20 71 75 65 73 74 73 2E
         * Use the #cDimensional Mirror# to move to a variety of party quests.
         * 00 00
         * 9B 69 8A 00 //9071003
         * 01 00 00 00 //1
         * 14 00 00 00 //20
         * A9 00 4D 6F 76 65 20 74 6F 20 74 68 65 20 70 61 72 74 79 20 7A 6F 6E 65 20 0A 23 63 4D 6F 6E 73 74 65 72 20 50 61 72 6B 23 2C 20 77 68 65 72 65 20 79 6F 75 20 63 61 6E 20 66 69 67 68 74 20 61 67 61 69 6E 73 74 20 73 74 72 6F 6E 67 20 6D 6F 6E 73 74 65 72 73 20 77 69 74 68 20 79 6F 75 72 20 70 61 72 74 79 20 6D 65 6D 62 65 72 73 2E 0A 23 63 4F 6E 6C 79 20 4C 76 2E 20 32 30 20 6F 72 20 61 62 6F 76 65 20 63 61 6E 20 70 61 72 74 69 63 69 70 61 74 65 20 69 6E 20 74 68 65 20 4D 6F 6E 73 74 65 72 20 50 61 72 6B 2E
         * Move to the party zone \n#cMonster Park#, where you can fight against strong monsters with your party members.\n#cOnly Lv. 20 or above can participate in the Monster Park.
         * 00 00
         * 96 54 89 00 //9000086
         * 05 00 00 00 //5
         * 00 00 00 00 //0
         * 49 00 4D 6F 76 65 20 74 6F 20 74 68 65 20 63 6C 6F 73 65 73 74 20 23 63 49 6E 74 65 72 63 6F 6E 74 69 6E 65 6E 74 61 6C 20 53 74 61 74 69 6F 6E 23 20 74 6F 20 79 6F 75 72 20 63 75 72 72 65 6E 74 20 6C 6F 63 61 74 69 6F 6E 2E
         * Move to the closest #cIntercontinental Station# to your current location.
         * 00 00
         * 97 54 89 00 //9000087
         * 03 00 00 00 //3
         * 00 00 00 00 //0
         * 47 00 4D 6F 76 65 20 74 6F 20 74 68 65 20 23 63 46 72 65 65 20 4D 61 72 6B 65 74 23 2C 20 77 68 65 72 65 20 79 6F 75 20 63 61 6E 20 74 72 61 64 65 20 69 74 65 6D 73 20 77 69 74 68 20 6F 74 68 65 72 20 75 73 65 72 73 2E
         * Move to the #cFree Market#, where you can trade items with other users.
         * 00 00
         * 98 54 89 00 //9000088
         * 04 00 00 00 //4
         * 1E 00 00 00 //30
         * 5D 00 4D 6F 76 65 20 74 6F 20 23 63 41 72 64 65 6E 74 6D 69 6C 6C 23 2C 20 74 68 65 20 74 6F 77 6E 20 6F 66 20 50 72 6F 66 65 73 73 69 6F 6E 73 2E 0A 23 63 4F 6E 6C 79 20 4C 76 2E 20 33 30 20 6F 72 20 61 62 6F 76 65 20 63 61 6E 20 6D 6F 76 65 20 74 6F 20 41 72 64 65 6E 74 6D 69 6C 6C
         * Move to #cArdentmill#, the town of Professions.\n#cOnly Lv. 30 or above can move to Ardentmill
         * 00 00
         * 99 54 89 00 //9000089
         * 06 00 00 00 //6
         * 00 00 00 00 //0
         * 30 00 54 61 6B 65 20 74 68 65 20 23 63 54 61 78 69 23 20 74 6F 20 6D 6F 76 65 20 74 6F 20 6D 61 6A 6F 72 20 61 72 65 61 73 20 71 75 69 63 6B 6C 79 2E
         * Take the #cTaxi# to move to major areas quickly.
         * 00 00
         * 79 7B 89 00 //9010041
         * 0A 00 00 00 //10
         * 1E 00 00 00 //30
         * 1D 00 52 65 63 65 69 76 65 20 50 61 72 74 2D 54 69 6D 65 20 4A 6F 62 20 72 65 77 61 72 64 2E
         * Receive Part-Time Job reward.
         * 00 00
         * BB 54 89 00
         * 0D 00 00 00
         * 01 00 00 00
         * 30 00 59 6F 75 20 63 61 6E 20 67 65 74 20 61 20 73 74 79 6C 69 73 68 20 68 61 69 72 63 75 74 20 66 72 6F 6D 20 42 69 67 20 48 65 61 64 77 61 72 64 2E
         * You can get a stylish haircut from Big Headward.
         * 00 00
         * BC 54 89 00
         * 0E 00 00 00
         * 01 00 00 00
         * 31 00 59 6F 75 20 63 61 6E 20 67 65 74 20 70 6C 61 73 74 69 63 20 73 75 72 67 65 72 79 20 66 72 6F 6D 20 44 72 2E 20 50 6C 61 73 74 69 63 20 52 6F 79 2E
         * You can get plastic surgery from Dr. Plastic Roy.
         */
        mplew.writeShort(SendPacketOpcode.QUICK_MOVE.getValue()); //Special Taxi & Boats

        mplew.write(QuickMove.values().length);
        for (QuickMove q : QuickMove.values()) {
            mplew.writeMapleAsciiString(""); //npc name?
            mplew.writeInt(q.getNpc());
            mplew.writeInt(q.getType()); // type
            mplew.writeInt(q.getLevel()); //level needed
            mplew.writeMapleAsciiString(q.getDescription()); // Description upon hovering
        }
    ...
    public static byte[] spawnPlayerMapobject(MapleCharacter chr) {
        ...
        if (chr.getBuffedValue(MapleBuffStat.SPIRIT_SURGE) != null) {
            ...
            buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.SPIRIT_SURGE).intValue()), Integer.valueOf(2)));
            buffvalue.add(new Pair(Integer.valueOf(chr.getBuffSource(MapleBuffStat.SPIRIT_SURGE)), Integer.valueOf(3)));
        }
        ...
        if (chr.getBuffedValue(MapleBuffStat.FAMILIAR_SHADOW) != null) {
            ...
            buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.FAMILIAR_SHADOW).intValue()), Integer.valueOf(3)));
            buffvalue.add(new Pair(Integer.valueOf(chr.getStatForBuff(MapleBuffStat.FAMILIAR_SHADOW).getCharColor()), Integer.valueOf(3)));
        }
    ...
    public static class NPCPacket {
        ...
        public static byte[] getAdviceTalk(String wzinfo) {
            ...
            mplew.write(1);
            mplew.write(1);
            mplew.writeMapleAsciiString(wzinfo);
            return mplew.getPacket();
        }
        ...
        public static byte[] getMapSelection(int npcid, String sel) {
            ...
            mplew.writeShort(0x11); //0x12 in v124
            mplew.writeInt(npcid == 3000012 ? 5 : npcid == 2083006 ? 1 : 0); //Map types
            mplew.writeInt(npcid == 9010022 ? 1/*31 in v124?*/ : npcid == 9201231 ? 1/*31 in v124?*/ : 0/*or 3, not confirmed*/); //UI types
        ...
        public static byte[] getTutorialUI(String data) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static Object getAndroidTalkStyle(int npc, String talk, int... args) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static class UIPacket {
        ...
        public static final byte[] getWheelNotice(byte type, int[] items, String randomstring) {
            ...
            //mplew.writeShort(SendPacketOpcode.RECEIVE_MAGIC_WHEEL);
