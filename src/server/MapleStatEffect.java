...
public class MapleStatEffect implements Serializable {
        ...
        if (ret.skill) { // Hack because we can't get from the datafile...
            switch (sourceid) {
                ...
                case 51121006:
                    ...
                    ret.statups.put(MapleBuffStat.CRITICAL_RATE_BUFF, ret.info.get(MapleStatInfo.x));
                    ret.statups.put(MapleBuffStat.CRITICAL_RATE_BUFF, ret.info.get(MapleStatInfo.x));
                    break;
                case 2111008:
                case 2211008:
                ...
                case 5220012:
                    ...
                    ret.statups.put(MapleBuffStat.PIRATES_REVENGE, ret.info.get(MapleStatInfo.damR)); // I think
                    break;
                case 5121009:
                case 15111005:
                ...
                case 23121004:// TODO: LEGEND
                    ret.statups.put(MapleBuffStat.PIRATES_REVENGE, ret.info.get(MapleStatInfo.damR));
                    break;
                case 1211009:
                case 1111007:
                ...
                case 4341003: // Monster Bomb
                    ret.monsterStatus.put(MonsterStatus.MONSTER_BOMB, ret.info.get(MapleStatInfo.damage));
                    break;
                ...
                case 4221004:
                    ret.monsterStatus.put(MonsterStatus.NINJA_AMBUSH, ret.info.get(MapleStatInfo.damage));
                    break;
                case 2311005:
                ...
                case 31121005:
                    ...
                    break;
                case 2311003: // Holysymbol
                case 9001002: // GM Holysymbol
                case 9101002:
                ...
                case 80001036: // Virtue
                    ...
                    break;
                case 2211004: // Ice Lightning Seal
                case 2111004: // Fire Posison Seal
                ...
                case 2321004: // Infinity
                    ...
                    break;
                case 22181004:
                    ret.statups.put(MapleBuffStat.ONYX_WILL, ret.info.get(MapleStatInfo.damage)); //is this the right order
                    ret.statups.put(MapleBuffStat.STANCE, ret.info.get(MapleStatInfo.prop));
                    break;
                case 1121002:
                case 1221002:
    ...
    public final boolean applyTo(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final Point pos, int newDuration) {
        if (isHeal() && (applyfrom.getMapId() == 749040100 || applyto.getMapId() == 749040100)) {
            ...
            applyfrom.getClient().getSession().write(CWvsContext.enableActions());
            return false;
        } else if (isShadow() && applyfrom.getJob() / 100 % 10 != 4) { // pirate / shadow = disconnect
            applyfrom.getClient().getSession().write(CWvsContext.enableActions());
            return false;
...
//	final ScheduledFuture<?> schedule = TimerManager.getInstance().schedule(cancelAction, ((starttime + 99999) - System.currentTimeMillis()));
    ...
    private void applyBuffEffect(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final int newDuration) {
        ...
        switch (sourceid) {
            ...
            case 32120000: { // Advanced dark aura
                ...
                statt.put(sourceid == 32110007 ? MapleBuffStat.BODY_BOOST : MapleBuffStat.AURA, sourceid == 32120000 ? applyfrom.getTotalSkillLevel(32001003) : level);
            ...
            case 32110000: { // Advanced blue aura
                ...
                applyto.cancelEffectFromBuffStat(MapleBuffStat.BODY_BOOST);
                final EnumMap<MapleBuffStat, Integer> statt = new EnumMap<>(MapleBuffStat.class);
                statt.put(sourceid == 32110008 ? MapleBuffStat.BODY_BOOST : MapleBuffStat.AURA, sourceid == 32110000 ? applyfrom.getTotalSkillLevel(32111012) : level);
            ...
            case 32120001: { // Advanced yellow aura
                ...
                applyto.cancelEffectFromBuffStat(MapleBuffStat.BODY_BOOST);
                final EnumMap<MapleBuffStat, Integer> statt = new EnumMap<>(MapleBuffStat.class);
                statt.put(sourceid == 32110009 ? MapleBuffStat.BODY_BOOST : MapleBuffStat.AURA, sourceid == 32120001 ? applyfrom.getTotalSkillLevel(32101003) : level);
    ...
    public boolean isMonsterBuff() {
        switch (sourceid) {
            case 1201006: // Threaten
            case 2101003: // Fire poison slow
            case 2201003: // Ice lightning slow
            case 5011002:
