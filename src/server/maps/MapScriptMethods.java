    ...
    public static void startScript_FirstUser(MapleClient c, String scriptName) {
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            case boss_Event_PinkZakum:
                c.getPlayer().getMap().startMapEffect("DO NOT BE ALARMED! The Pink Zakum Clone was just to help Adventurers like you to relieve stress!", 5120039);
                break;
            case dojang_Eff: {
            ...
            case dojang_Msg:
            case balog_summon:
            case easy_balog_summon: { // We don't want to reset
                break;
            }
        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            case map_913070000: {
                try {
                    ...
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 500));
                    Thread.sleep(500);
                    c.getSession().write(CWvsContext.getTopMsg("Month 3, Day 4"));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 1000));
                    Thread.sleep(1000);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/0", 2000, 0, -100, 1));
                    c.getSession().write(CField.facialExpression2(6, 10000));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 2000));
                    Thread.sleep(2000);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/1", 2000, 0, -100, 1));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 2000));
                    Thread.sleep(2000);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/2", 3000, 0, -100, 1));
                    c.getSession().write(CField.facialExpression2(4, 8000));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 3000));
                    Thread.sleep(3000);
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 3, 1));
                    Thread.sleep(1000);
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 3, 0));
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/3", 2000, 0, -100, 1));
                    ...
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 3, 0));
                    Thread.sleep(500);
                    NPCScriptManager.getInstance().start(c, 1106000, "tuto001");
            ...
            case map_913070004: {
                try {
                    ...
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 1000));
                    Thread.sleep(1000);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/5", 2000, 0, -100, 1));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 2000));
                    Thread.sleep(2000);
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 3, 2));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 500));
                    Thread.sleep(500);
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 3, 0));
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/6", 2000, 0, -100, 1));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 1000));
                    Thread.sleep(1000);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/4", 2000, 0, -100, 1));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 1000));
                    Thread.sleep(1000);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/7", 2000, 0, -100, 1));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 2000));
                    Thread.sleep(2000);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction7.img/effect/tuto/step0/8", 2000, 0, -100, 1));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 1000));
                    Thread.sleep(1000);
            ...
            case PTtutor000: {
                try {
                    ...
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 1000));
                    Thread.sleep(1000);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/OnUserEff.img/questEffect/phantom/tutorial", 2000, 0, -100, 1));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 3, 0));
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 1, 1000));
                    Thread.sleep(1000);
                    c.getSession().write(CField.UIPacket.getDirectionInfoTest((byte) 3, 2));
            ...
            case PTtutor300: {
                ...
                c.getSession().write(NPCPacket.getAdviceTalk("UI/tutorial/phantom/0/0"));
                ...
                //NPCScriptManager.getInstance().start(c, 9010000, "PTtutor300_UI");
                //spawn guards packet
                break;
            }
            case PTtutor301: {
