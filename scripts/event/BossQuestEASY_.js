...
function allMonstersDead(eim) {
    ...
    var num = mobnum * 1; // 765 points in total
	...
	eim.saveBossQuest(1);
	eim.broadcastPlayerMsg(5, "Your party has beaten the EASY mode and have gained 1 extra point!");
	eim.giveAchievement(149);
    }
