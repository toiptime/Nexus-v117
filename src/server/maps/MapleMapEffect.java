...
public class MapleMapEffect {
    ...
    public byte[] makeDestroyData() { // Jukebox doesn't REALLY have a destroy, but 0 stops all music
        return jukebox ? MTSCSPacket.playCashSong(0, "") : CField.removeMapEffect();
    }

    public byte[] makeStartData() {
        return jukebox ? MTSCSPacket.playCashSong(itemId, msg) : CField.startMapEffect(msg, itemId, active);
    }
